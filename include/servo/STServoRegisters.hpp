...
namespace STServo {
    ...
    namespace Register {
        ...
        static constexpr Reg FIRMWARE_SUB_VER    = { 0x01, 1, MemoryArea::EEPROM, Access::R  }; // init 6
        static constexpr Reg SERVO_MAIN_VER      = { 0x03, 1, MemoryArea::EEPROM, Access::R  }; // init 9
        static constexpr Reg SERVO_SUB_VER       = { 0x04, 1, MemoryArea::EEPROM, Access::R  }; // init 3
        ...
        static constexpr Reg RESPONSE_LEVEL  = { 0x08, 1, MemoryArea::EEPROM, Access::RW }; // init 0  | 0-1   (0=ping only,1=all)

        // --- EEPROM — motion limits ------------------------------------------
        static constexpr Reg MIN_ANGLE_LIMIT = { 0x09, 2, MemoryArea::EEPROM, Access::RW }; // init 0    | 0-4094  | step
        static constexpr Reg MAX_ANGLE_LIMIT = { 0x0B, 2, MemoryArea::EEPROM, Access::RW }; // init 4095 | 1-4095  | step
        ...
        static constexpr Reg ANGULAR_RESOLUTION = { 0x1E, 1, MemoryArea::EEPROM, Access::RW }; // init 1   | 1-100
        ...
        static constexpr Reg OPERATION_MODE        = { 0x21, 1, MemoryArea::EEPROM, Access::RW }; // init 0 | 0=servo,1=constant-speed,2=PWM
        static constexpr Reg PROTECTIVE_TORQUE     = { 0x22, 1, MemoryArea::EEPROM, Access::RW }; // init 20  | 0-254  | 1 %
        static constexpr Reg PROTECTION_TIME       = { 0x23, 1, MemoryArea::EEPROM, Access::RW }; // init 200 | 0-254  | 10 ms
        static constexpr Reg OVERLOAD_TORQUE       = { 0x24, 1, MemoryArea::EEPROM, Access::RW }; // init 80  | 0-254  | 1 %
        static constexpr Reg SPEED_P_COEFF         = { 0x25, 1, MemoryArea::EEPROM, Access::RW }; // init 10  | 0-254  (mode 1 speed loop P)
        ...
        static constexpr Reg TARGET_LOCATION     = { 0x2A, 2, MemoryArea::SRAM, Access::RW }; // -32766..32766 | step
        // 0x2C RUNNING_TIME: ST-series (e.g. ST3215) have no time mode;
        // always written as 0x0000 in the atomic move packet to reach
        // RUNNING_SPEED at 0x2E in one WRITE transaction.
        static constexpr Reg RUNNING_TIME        = { 0x2C, 2, MemoryArea::SRAM, Access::RW }; // 0-1000 | 0.1 %  (ST3215: unused, keep 0)
        static constexpr Reg OPERATION_SPEED     = { 0x2E, 2, MemoryArea::SRAM, Access::RW }; // 0-254 | step/s  (alias: RUNNING_SPEED)
        static constexpr Reg TORQUE_LIMIT        = { 0x30, 2, MemoryArea::SRAM, Access::RW }; // 0-1000 | 1.0 %  (init = MAX_TORQUE value)
        static constexpr Reg LOCK_MARK           = { 0x37, 1, MemoryArea::SRAM, Access::RW }; // 0=open EEPROM writes, 1=lock EEPROM writes
        ...
        static constexpr Reg MOBILE_SIGN         = { 0x42, 1, MemoryArea::SRAM, Access::R  }; // 1=moving, 0=stopped
